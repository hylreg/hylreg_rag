    ...
    while True:
        try:
            ...
            if result['source_documents']:
                print(f"\n参考来源:")
                for i, source in enumerate(result['source_documents'][:2], 1):  # 只显示前2个来源
...
def main():
    ...
    parser.add_argument("--load-index", action="store_true", help="从本地向量库目录加载索引")
    parser.add_argument("--save-index", action="store_true", help="将当前向量库保存到本地目录")
